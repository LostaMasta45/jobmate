...
function ResetPasswordContent() {
  ...
  React.useEffect(() => {
    if (!isMobile && isMounted && tokenValid) {
      setTimeout(() => passwordInputRef.current?.focus(), 500);
    }
  }, [isMobile, isMounted, tokenValid]);
  ...
  const handleUpdatePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        setError(data.error || 'Gagal mengupdate password');
        setLoading(false);
        return;
      }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background p-4">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-2">Token Tidak Valid</h2>
            <p className="text-muted-foreground">{error || "Link reset password tidak valid atau sudah kedaluwarsa."}</p>
          </div>
          <Link href="/reset">
          ...
          <div className="h-full overflow-y-auto px-8 pt-8 pb-20 scrollbar-hide">
            {success ? (
              ...
              >
                ...
                <p className="text-slate-600 text-sm">Redirect ke halaman login...</p>
              </motion.div>
            ) : (
            ...
            {success ? (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-2">Redirect ke halaman login...</p>
                </div>
              </motion.div>
            ) : (
              <motion.div
              ...
              >
                <div className="space-y-2 mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Pilih password yang kuat untuk akun <strong>{userEmail}</strong>
                  </p>
                </div>
