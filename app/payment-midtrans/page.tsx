...
function PaymentFormContent() {
    ...
    // Real-time validation handlers (same as original)
                                ...
                                >
                                    ...
                                    >
                                        <Button
                                            type="submit"
                                            size="lg"
                                            className={`w-full h-14 bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 hover:from-amber-600 hover:via-orange-600 hover:to-red-600 text-white font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] relative overflow-hidden ${loading ? 'cursor-wait' : ''
                                                }`}
                                            disabled={loading}
                                        >
...
export default function PaymentMidtransPage() {
    return (
        <Suspense fallback={
