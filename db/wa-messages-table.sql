...
create table if not exists wa_messages (
  ...
  variation_level text default 'medium' check (variation_level in ('low', 'medium', 'high')),
  use_emoji boolean default false,
...
insert into wa_templates (name, description, message_type, template_content, default_tone, default_length, default_variation, is_system, display_order)
values
  (
    'Express Application',
...
[NAMA]',
  ...
  (
    ...
    'application',
    '{Selamat pagi|Selamat siang} {Bapak/Ibu|Kak} [HRD_NAME],
...
[NAMA]',
  ...
  (
    ...
    'follow_up',
    '{Assalamu''alaikum|Selamat siang} Kak [HRD_NAME],
...
{Terima kasih|Mohon maaf jika mengganggu} 🙏',
  ...
  (
    ...
    '{Terima kasih|Terima kasih banyak} Kak [HRD_NAME] atas undangan interviewnya 🙏
...
[NAMA]',
  ...
  (
    ...
    'thank_you',
    '{Halo|Selamat siang} Kak [HRD_NAME],
