...
export function StepBasicInfo({ formData, updateFormData }: StepBasicInfoProps) {
    ...
    return (
        <div className="space-y-8">
            ...
            <Card className="group relative overflow-hidden border-0 bg-gradient-to-br from-purple-heart-500/5 to-heliotrope-500/10 dark:from-purple-900/10 dark:to-blue-900/10 backdrop-blur-md rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="absolute top-0 right-0 w-32 h-32 bg-purple-heart-500/10 rounded-full blur-[50px] -translate-y-1/2 translate-x-1/2" />

                <div className="p-6 sm:p-8">
                    <div className="flex items-start justify-between mb-4">
                        <div className="space-y-1">
                            <div className="flex items-center gap-2">
                                <div className="p-2 rounded-lg bg-purple-heart-500/10 text-purple-heart-600">
                        ...
                        <div className="hidden sm:block">
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-purple-heart-600 to-heliotrope-600 text-white text-xs font-bold shadow-lg shadow-purple-heart-500/20">
                    ...
                    {!previewImage ? (
                        <div
                            ...
                            className="relative group/upload border-2 border-dashed border-purple-heart-200 dark:border-purple-800 rounded-2xl p-8 text-center cursor-pointer hover:border-purple-heart-500 hover:bg-purple-heart-50/50 dark:hover:bg-purple-900/20 transition-all duration-300"
                        >
                            <input
                                ref={fileInputRef}
                                type="file"
                            ...
                            <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-white dark:bg-zinc-900 shadow-md flex items-center justify-center group-hover/upload:scale-110 group-hover/upload:shadow-lg transition-all duration-300">
                                <UploadCloud className="h-8 w-8 text-purple-heart-500" />
                            </div>
                        ...
                        <div className="relative">
                            {isAnalyzing && (
                                <div className="absolute inset-0 bg-background/80 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center z-10 animate-in fade-in duration-300">
                                    <Loader2 className="h-10 w-10 animate-spin text-purple-heart-500 mb-3" />
                                    <p className="font-semibold text-purple-heart-600">Menganalisis Poster...</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2.5 col-span-2">
                        ...
                        <Input
                            ...
                            className="h-12 text-base rounded-xl border-muted-foreground/20 focus:border-purple-heart-500 focus:ring-purple-heart-500/20 bg-background/50"
                        />
                    </div>
                    ...
                    <div className="space-y-2.5">
                        <Label htmlFor="jobSource" className="text-base font-medium flex items-center gap-2 text-foreground">
                            <Search className="h-4 w-4 text-purple-heart-500" />
