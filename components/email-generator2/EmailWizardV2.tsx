...
export function EmailWizardV2({ userName = '', onBack }: EmailWizardV2Props) {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-4rem)] bg-gradient-to-br from-purple-heart-50/50 via-background to-robins-egg-blue-50/30 dark:from-purple-950/20 dark:via-background dark:to-cyan-950/20 overflow-hidden relative">
            ...
            <div className="flex-none z-20 bg-white/70 dark:bg-black/70 backdrop-blur-md border-b border-white/20 dark:border-white/10 shadow-sm relative">
                ...
                <div className="absolute top-0 left-0 right-0 h-1 bg-muted/20">
                    <motion.div
                        className="h-full bg-gradient-to-r from-purple-heart-500 via-heliotrope-500 to-robins-egg-blue shadow-[0_0_10px_rgba(142,104,253,0.5)]"
                        initial={{ width: 0 }}
                                ...
                                <div key={step.id} className="flex items-center">
                                    <div className={`
                                        ...
                                        ${currentStep > step.id
                                            ...
                                            : currentStep === step.id
                                                ? 'bg-purple-heart-500 text-white ring-4 ring-purple-heart-500/20 shadow-purple-heart-500/30 shadow-lg scale-110'
                ...
                <div className="max-w-3xl mx-auto px-4 py-8 min-h-full">
                    ...
                    <div className="text-center mb-8">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-heart-50 text-purple-heart-600 dark:bg-purple-900/30 dark:text-purple-300 text-sm font-medium mb-4 shadow-sm border border-purple-heart-100 dark:border-purple-800"
                        >
                    ...
                    <div className="flex-none z-20 bg-white/80 dark:bg-black/80 backdrop-blur-md border-t border-white/20 dark:border-white/10 py-4 px-4 shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
                        <div className="max-w-3xl mx-auto flex gap-4 items-center">
                            ...
                            <Button
                                ...
                                ${currentStep === 2
                                        ? 'bg-gradient-to-r from-purple-heart-600 to-heliotrope-600 hover:from-purple-heart-500 hover:to-heliotrope-500 text-white shadow-purple-heart-500/25'
