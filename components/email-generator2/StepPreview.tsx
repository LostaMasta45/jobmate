        ...
        <div className="space-y-6">
            ...
            >
                <Card className="overflow-hidden shadow-xl border-0 bg-white/60 dark:bg-black/40 backdrop-blur-xl rounded-2xl">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-purple-heart-500/10 via-heliotrope-500/5 to-transparent p-4 border-b border-purple-heart-500/10 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {!isEditing && (
                                <Button
                                    ...
                                    className="h-8 hover:bg-purple-heart-50 dark:hover:bg-purple-900/20 hover:text-purple-heart-600 transition-colors"
                                >
                        ...
                        {isEditing ? (
                            ...
                            >
                                <div className="space-y-3">
                                    <Label className="text-base font-semibold text-purple-heart-600 dark:text-purple-heart-400">Subject</Label>
                                    <Input
                                        value={editedSubject}
                                        onChange={(e) => setEditedSubject(e.target.value)}
                                        className="font-medium text-lg h-12 bg-background/50 border-purple-heart-200 focus:border-purple-heart-500 transition-all rounded-xl"
                                    />
                                </div>
                                <div className="space-y-3">
                                    <Label className="text-base font-semibold text-purple-heart-600 dark:text-purple-heart-400">Body Email</Label>
                                    <Textarea
                                        value={editedBody}
                                        onChange={(e) => setEditedBody(e.target.value)}
                                        className="min-h-[350px] font-mono text-sm leading-relaxed bg-background/50 border-purple-heart-200 focus:border-purple-heart-500 transition-all rounded-xl p-4 resize-y"
                                    />
                                </div>
                                <div className="flex gap-3 justify-end pt-2">
                                    ...
                                    <Button onClick={handleSaveEdit} className="rounded-xl bg-purple-heart-600 hover:bg-purple-heart-700 text-white shadow-lg shadow-purple-heart-500/20">
                ...
                <Card className="p-4 sm:p-5 shadow-xl border-white/20 bg-white/40 dark:bg-black/40 backdrop-blur rounded-2xl">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                        <Button
                            onClick={handleCopy}
                            variant="outline"
                            className="h-12 sm:h-14 gap-2.5 rounded-xl border-muted-foreground/20 hover:bg-purple-heart-50 hover:text-purple-heart-600 hover:border-purple-heart-200 dark:hover:bg-purple-900/20 transition-all active:scale-95"
                        >
                            {copied ? (
                                <>
                        ...
                        <Button
                            ...
                            className="h-12 sm:h-14 gap-2.5 rounded-xl bg-gradient-to-br from-purple-heart-600 to-heliotrope-600 hover:from-purple-heart-700 hover:to-heliotrope-700 text-white shadow-lg shadow-purple-heart-500/20 transition-all active:scale-95 hover:translate-y-[-2px]"
                        >
                    ...
                    <div className="mt-4 pt-3 border-t border-border/50 flex justify-center">
                        <Button
                            onClick={onReset}
                            variant="ghost"
                            className="gap-2 text-muted-foreground hover:text-purple-heart-500 hover:bg-purple-heart-50/50 rounded-full px-6 transition-all"
                        >
