...
export function Template20SlatePro({ data }: { data: FormState }) {
  ...
  return (
    <div className="space-y-3" style={{ fontFamily: 'Tahoma, sans-serif', fontSize: '10.5pt', lineHeight: '1.5', color: 'var(--theme-text, #0f172a)' }}>
      <div style={{ borderLeft: '5px solid var(--theme-primary, #475569)', paddingLeft: '12px', marginBottom: '12px' }}>
        <div style={{ fontSize: '12pt', fontWeight: 'bold', color: 'var(--theme-primary, #475569)' }}>PERMOHONAN KERJA</div>
      ...
      <p style={{ fontSize: '10pt' }}>
        Nama saya <strong>{biodata.namaLengkap || "—"}</strong>, melamar untuk posisi <strong style={{ color: 'var(--theme-primary, #475569)' }}>{perusahaan.posisiLowongan || "—"}</strong>.
      </p>
      ...
      <div style={{ 
        ...
        gap: '10px', 
        padding: '10px', 
        backgroundColor: 'var(--theme-accent, #f1f5f9)', 
        borderRadius: '4px',
        fontSize: '9pt',
        marginTop: '8px',
        marginBottom: '8px'
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 'bold', marginBottom: '4px', color: 'var(--theme-primary, #475569)' }}>PROFIL</div>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 'bold', marginBottom: '4px', color: 'var(--theme-primary, #475569)' }}>KONTAK</div>
      ...
      {perusahaan.lampiran && perusahaan.lampiran.length > 0 && (
        <div>
          <div style={{ fontWeight: 'bold', fontSize: '10pt', color: 'var(--theme-primary, #475569)', marginBottom: '4px' }}>LAMPIRAN:</div>
          <div style={{ fontSize: '9pt' }}>
            {perusahaan.lampiran.map((item, i) => (
              <div key={i} style={{ padding: '3px 0 3px 12px', borderLeft: '2px solid var(--theme-accent, #cbd5e1)' }}>• {item}</div>
            ))}
          </div>
        </div>
      )}
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <div style={{ borderTop: '2px solid var(--theme-primary, #475569)', paddingTop: '4px', display: 'inline-block' }}>
