...
export function TemplateNavy({ data }: Props) {
  const { biodata, perusahaan } = data

  return (
    <div className="template-navy">
      {/* Navy Corporate Header */}
      <div style={{ 
      ...
      <div className="section-gap" style={{
        ...
        <p style={{ margin: 0, marginBottom: '8pt' }}><strong style={{ color: '#1E3A8A' }}>Data Pribadi:</strong></p>
        <KeyValueTable rows={[
