...
export function PDFToolLayout({
    ...
    return (
        <div className="h-full w-full bg-slate-50 dark:bg-[#050505] text-slate-900 dark:text-white font-sans selection:bg-red-500/30 relative transition-colors duration-500 flex flex-col overflow-hidden">
            ...
            <div className={`absolute bottom-[-20%] right-[-10%] w-[40%] h-[40%] bg-${theme === 'red' ? 'blue' : theme === 'blue' ? 'purple' : 'teal'}-600/10 dark:bg-${theme === 'red' ? 'blue' : theme === 'blue' ? 'purple' : 'teal'}-600/10 rounded-full blur-[100px] pointer-events-none mix-blend-multiply dark:mix-blend-screen opacity-50 dark:opacity-100 fixed`} />
