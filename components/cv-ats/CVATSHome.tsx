...
export function CVATSHome({ onSelectView, totalResumes = 0 }: CVATSHomeProps) {
    ...
    return (
        <div className="h-full w-full overflow-y-auto bg-slate-50/50 dark:bg-black/95 text-slate-900 dark:text-slate-100 font-sans selection:bg-purple-500/30">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 dark:from-white dark:via-slate-200 dark:to-slate-400 leading-tight">
                        Build Your <span className="text-purple-600 dark:text-purple-500 relative inline-block">
                            Future
                            <svg className="absolute w-full h-3 -bottom-1 left-0 text-purple-400 opacity-40" viewBox="0 0 100 10" preserveAspectRatio="none">
                    ...
                    <p className="text-base md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed px-4">
                        Buat CV <span className="font-bold text-slate-900 dark:text-white">ATS-friendly</span> profesional dalam hitungan menit. Tanpa ribet formatting, fokus pada konten.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <div className="md:col-span-8 lg:col-span-8">
                        ...
                        >
                            <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-purple-500/30 rounded-full blur-[100px] -mr-20 -mt-20 pointer-events-none" />
                            ...
                            <div className="p-6 md:p-8 xl:p-10 flex flex-col xl:flex-row items-center h-full gap-6 xl:gap-8 relative z-10">
                                <div className="flex-1 space-y-6 w-full text-center xl:text-left">
                                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-500/10 dark:bg-purple-500/20 text-purple-600 dark:text-purple-300 text-[10px] md:text-xs font-bold uppercase tracking-wider border border-purple-500/20 backdrop-blur-sm mx-auto xl:mx-0">
                                        <Sparkles className="h-3 w-3 animate-pulse" />
                                        Recommended • Smart Wizard
                                    </div>
                                    <h2 className="text-3xl md:text-4xl xl:text-5xl font-bold leading-tight tracking-tight">
                                        Buat CV Baru <br /> <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-600">Dalam 5 Menit.</span>
                                    </h2>
                                    <p className="text-slate-400 text-base md:text-lg max-w-md mx-auto xl:mx-0 leading-relaxed">
                                        Wizard 6 langkah pintar dengan optimasi keyword otomatis. <span className="text-purple-400 font-semibold">10x lebih cepat</span> dari cara manual.
                                    </p>
                                    <Button className="w-full md:w-auto rounded-xl bg-white text-slate-900 dark:bg-purple-600 dark:text-white hover:bg-slate-50 dark:hover:bg-purple-700 border-none px-8 py-6 text-base md:text-lg font-bold shadow-xl shadow-purple-900/10 dark:shadow-purple-900/20 group hover:scale-[1.02] transition-all duration-300">
                                        Mulai Sekarang
                                ...
                                <div className="relative w-full max-w-[280px] md:max-w-[320px] xl:max-w-none xl:w-64 h-64 md:h-72 xl:h-64 flex-shrink-0 perspective-1000 block mt-4 xl:mt-0">
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 p-6 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 shadow-xl mb-4 group-hover:rotate-6 transition-transform duration-500">
                        ...
                        >
                            <div>
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <span className="text-xs font-bold uppercase text-slate-400 tracking-wider">Impact</span>
                                </div>
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mt-2">Resumes Created</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-auto">
                                <div className="grid grid-cols-2 gap-2 mb-4">
                                    <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-800/30 border border-slate-100 dark:border-zinc-700/50 text-center">
                                        ...
                                        <div className="text-[10px] text-slate-400 uppercase font-semibold tracking-wide">ATS Score</div>
                                    </div>
                                    <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-800/30 border border-slate-100 dark:border-zinc-700/50 text-center">
                                        <div className="text-lg font-bold text-slate-900 dark:text-white">PDF</div>
                                        <div className="text-[10px] text-slate-400 uppercase font-semibold tracking-wide">Export</div>
                                    </div>
                                </div>
                                <Button variant="outline" className="w-full rounded-xl border-slate-200 dark:border-zinc-700 hover:border-purple-500/30 dark:hover:border-purple-500/30 hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-600 dark:text-slate-300 transition-colors" disabled>
                                    View Analytics
                                </Button>
                            </div>
                        </MagicCard>
                    ...
                    <div className="md:col-span-12">
                        <HistoryCard
                            ...
                            description="Akses & edit resume yang sudah Anda buat sebelumnya."
                            icon={History}
