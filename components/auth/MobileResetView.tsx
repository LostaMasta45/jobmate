    ...
    return (
      <div className="fixed inset-0 w-full h-full bg-white overflow-hidden font-sans text-slate-900">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full p-8 text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-2 relative z-10">Email Terkirim!</h2>
          <p className="text-white/90 mb-8 max-w-xs mx-auto">
            Silakan cek kotak masuk email Anda dan klik tautan untuk mereset kata sandi.
          </p>
          
          <Link href="/sign-in" className="w-full">
            <Button className="w-full h-14 rounded-full bg-white text-[#5547d0] font-bold text-lg shadow-xl hover:bg-slate-50">
              Kembali ke Masuk
            </Button>
          </Link>
        </div>
